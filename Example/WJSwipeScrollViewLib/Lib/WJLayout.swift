...
let wj_sliderDefaultWidth: CGFloat = 40.010101010

public class WJLayout: NSObject {
    ...
    @objc public var sliderWidth: CGFloat = wj_sliderDefaultWidth
    ...
    /* 是否悬停 默认为true开启悬停 此属性仅对WJSimpleManager有效 关闭时记得修改viewControll的frame*/
